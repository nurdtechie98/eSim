...
class PrcocessNetlist:
    ...
    def convertICintoBasicBlocks(
        ...
        unknownModelList = []
        multipleModelList = []
        plotList = ['plot_v1', 'plot_v2', 'plot_i2',
                    'plot_log', 'plot_db', 'plot_phase']
            ...
            if compName[0] == 'u' or compName[0] == 'U':
                ...
                if compType != "port" and compType != "ic" and compType not in plotList and compType != 'transfo':
                    ...
                    if count > 1:
                        ...
                        try:
                            print(
                                "Start Parsing Previous Values XML for ngspice model :",
                                modelPath)
                    ...
                    # For Primary Couple
                    modelLine = "a" + \
                        str(k) + " (" + words[1] + " " + words[2] + ") (interNode_" + \
                    ...
                    modelLine = "a" + str(k) + " (interNode_" + str(interMediateNodeCount) + \
                        " interNode_" + str(interMediateNodeCount + 1) + ") "
